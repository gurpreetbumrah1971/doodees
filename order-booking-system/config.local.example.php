...
return [
  // Required. Without these four plus APP_SECRET, config.php refuses to run.
  'DB_HOST' => 'localhost',
  'DB_NAME' => 'paste-your-database-name',
  'DB_USER' => 'paste-your-database-user',
  'DB_PASS' => 'paste-your-database-password',
  // A long random string used to sign customer/admin session tokens. Generate
  // one with: php -r "echo bin2hex(random_bytes(32));"
  'APP_SECRET' => 'paste-a-long-random-secret',
